...
-- Get only the customer rows where the `id` field value
SELECT
    a.id,
    a.name,
    a.address,
...
-- Get only the employee rows where the `id` field value
SELECT
    a.id,
    a.name,
    a.address,
...
-- Get only the location rows where the `id` field value
SELECT
    a.id,
    a.name,
    a.address
...
-- Query the database to see if it was added
SELECT * 
FROM Animal 
ORDER BY id DESC;